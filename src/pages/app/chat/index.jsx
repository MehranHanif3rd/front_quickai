    ...
    <div className="flex lg:space-x-5 chat-height overflow-hidden relative rtl:space-x-reverse">
      ...
      >
        ...
        >
          ...
          <div className="border-b p-3 border-slate-500 dark:border-slate-700 py-5 ">
            <div className="search p-2 bg-gray-100 px-3 mx-6 rounded flex items-center  rtl:space-x-reverse">
          ...
          <div className="flex justify-center border-b border-slate-100 h-10 dark:border-slate-700 ml-4 mr-4 bg-teal-500 mb-full">
            <button className=" text-slate-100 ">New Conversation</button>
          </div>
